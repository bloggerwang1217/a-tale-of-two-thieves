...
\begin{itemize}
	...
	The test statistic
	DW ∈ [0, 4] with DW ≈ 2 indicating no
	...
	coefficient (ρ) and adjusts standard errors and
	inference accordingly.
\end{itemize}

\textbf{Key Difference:} Durbin-Watson tests
...
coefficient (ρ ≈ 0.12) is
small and non-significant, confirming that temporal
dependence is negligible.
This result is consistent with what a non-significant
Durbin-Watson test
would indicate, but the AR(1) approach provides the
...
More significantly, this study revealed process-related issues of greater importance than the choice of sampling instrument. The primary source of product variability is a substantial lack of mixture uniformity within the V-Blender, with location-to-location variation accounting for 31.05\% of total measurement variance (13.5-fold greater than the METHOD effect). Additionally, a systematic loss of approximately 3\% of the active ingredient occurs during the powder-to-tablet compression stage. These findings indicate that further analysis and process improvement efforts should be focused on these critical manufacturing areas to enhance final product quality and regulatory compliance.
...
\section{Appendix C: Technical Specifications and Software}
